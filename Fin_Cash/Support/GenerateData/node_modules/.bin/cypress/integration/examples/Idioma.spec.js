it("Cria idiomas", function() {
    var nomes = [
      ...
      var idiomas = [        
        ...
        // { id: 3, name: 'Alemao' },//1 Idiomade-DE
        // { id: 5, name: 'Arabe' },//2 Idiomaar-AE
        // { id: 18, name: 'Chines' },//3 Idiomazh-CN
        // { id: 21, name: 'Coreano' },//4 Idiomako_KR
        // { id: 28, name: 'Espanhol' },//5 Idiomaes-ES
        // { id: 33, name: 'Frances' },//6 Idiomafr_FR
        // { id: 45, name: 'Hindi' },//7 Idiomahi_IN
        // { id: 56, name: 'Italiano' },//8 Idiomait_IT
        // { id: 57, name: 'Japones' },//9 Idiomaja_JP
        { id: 83, name: 'Russo' }//10 Idiomaru_RU
      ];
    ...
    cy.wait(1000).then(
        () => {            
            ...
            {                   
                ...
                cy.writeFile('Idiomaru_RU.json', obj);
                console.log(obj);
